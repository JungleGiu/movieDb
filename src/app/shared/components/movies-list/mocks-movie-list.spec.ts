import type { TMDBresponse } from '../../../core/services/api';
...
export const mockMovie: Movie = {
  ...
  production_companies: [{ id: 101, name: 'Mock Studio' }],
...
export const mockMoviesList: Movie[] = [
  { ...mockMovie, id: 1, title: 'Mock Movie 1' },
  { ...mockMovie, id: 2, title: 'Mock Movie 2' },
  { ...mockMovie, id: 3, title: 'Mock Movie 3' },
];

export const mockTvseriesList: Tvserie[] = [
  { ...mockTvserie, id: 101, name: 'Mock TV Series 1' },
  { ...mockTvserie, id: 102, name: 'Mock TV Series 2' },
  { ...mockTvserie, id: 103, name: 'Mock TV Series 3' },
];

export const mockCrewcastList: CrewcastMember[] = [
  { ...mockCrewcastMember, id: 1001, name: 'Crew Member 1' },
  { ...mockCrewcastMember, id: 1002, name: 'Crew Member 2' },
  { ...mockCrewcastMember, id: 1003, name: 'Crew Member 3' },
];
